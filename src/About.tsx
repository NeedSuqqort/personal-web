    ...
    return(
      <Box minHeight={'100vh'}>
        <div className="space-y-4 items-center px-8 py-6">
            <h1 className="text-3xl text-center text-yellow-600 font-bold">About me</h1>
            ...
            <Box className="rounded-3xl" p={5} my={10}>
                ...
                <pre className="note">
                    I am currently learning various front-end frameworks and tools such as Next.js, Tailwind CSS, etc.
                </pre>
            </Box>
            ...
            <Box className="rounded-3xl" p={5} my={10}>
                <h2>Bachelor of Engineering, Hong Kong University of Science and Technology</h2>
                <pre>
                  <ul>                    
                      <li>
                          2021-2025
                      ...
                      <li>
                          With an extended major on <strong>Artifical intelligence(AI)</strong>
                      </li>
                      <li>
                          <strong className="text-pink-500">Dean's List in 2022 Fall Term</strong>
                      </li>
                  </ul>
                </pre>
            </Box>     
            ...
            <Box className="rounded-3xl" py={4}>
                <Flex direction="row" className="min-w-full" justify="space-between">
                    <h2 className="text-left">Programmer Intern, TURNED-E! Company</h2>
                    <h2 className="text-right">Dec 2023 - Present</h2>
                </Flex>
                <pre>
                    <ul>                    
                        <li>
                            Gained hands-on experience on front-end developement and in touch with production code.
                        </li>
                    </ul>
                </pre>
            </Box>
            ...
            <div className="flex justify-center">
                <Button className="flex place-self-center" colorScheme="blue" variant="outline" onClick={() => navigate("/")} my={10}>
